    ...
    <main className="flex flex-col items-center w-full px-4 pt-10 pb-20 text-sm font-mono text-gray-200 bg-black overflow-x-hidden">
      <div className="w-full max-w-3xl mx-auto">
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Manifesto</h2>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">About MathsMine3</h2>
          <p className="leading-relaxed text-center md:text-left">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Privacy Policy</h2>
          <p className="leading-relaxed text-center md:text-left">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Donation Disclaimer</h2>
          <p className="leading-relaxed text-center md:text-left">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Terms of Use</h2>
          <p className="leading-relaxed text-center md:text-left">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Copyright</h2>
          <p className="leading-relaxed text-center md:text-left">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Sources</h2>
          <p className="leading-relaxed text-center md:text-left">
            Wikipedia:{' '}
            <a
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Image Credits</h2>
          <p className="leading-relaxed text-center md:text-left">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-2 text-center md:text-left">Contact</h2>
          <p className="leading-relaxed text-center md:text-left">
