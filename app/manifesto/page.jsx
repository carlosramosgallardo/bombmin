  ...
  return (
    <main className="flex flex-col items-center w-full px-4 pt-10 pb-20 text-sm font-mono text-gray-200 bg-black overflow-x-hidden">
      <div className="w-full max-w-full md:max-w-3xl mx-auto">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">About MathsMine3</h2>
          <p className="leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Donation Disclaimer</h2>
          <p className="leading-relaxed">
        ...
        <section className="mb-6">
          ...
          <p className="leading-relaxed">Please, report if you identify any inaccuracies or discrepancies.</p>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Image Credits</h2>
          <p className="leading-relaxed">
