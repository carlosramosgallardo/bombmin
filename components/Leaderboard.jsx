...
export default function Leaderboard() {
  ...
  return (
    <div className="mt-8 p-4 bg-[#0b0f19] rounded-xl shadow-lg">
      <div className="overflow-x-auto">
        <table className="table-auto w-auto mx-auto border border-[#22d3ee] border-dotted text-sm md:text-base">
          <thead className="bg-[#22d3ee] text-black">
            <tr>
          ...
          <tbody className="bg-[#22d3ee] text-black">
            {isLoading ? (
              <tr>
